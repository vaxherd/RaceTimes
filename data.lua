...
local ZONES = {
    ...
    Zone("The Ringing Deeps", 2214, {
         {40.86, 11.31, 444148, "Earthenworks Weave",
                                {NORMAL    = {80237, 2941, 52, 57},
                                 ADVANCED  = {80243, 2947, 49, 52},
                                 REVERSE   = {80249, 2953, 50, 53}}},
         {42.23, 27.44, 444149, "Ringing Deeps Ramble",
                                {NORMAL    = {80238, 2942, 57, 62},
                                 ADVANCED  = {80244, 2948, 53, 56},
                                 REVERSE   = {80251, 2954, 53, 56}}},
         {67.89, 34.82, 444150, "Chittering Concourse",
                                {NORMAL    = {80239, 2943, 56, 61},
                                 ADVANCED  = {80246, 2949, 53, 56},
                                 REVERSE   = {80252, 2955, 54, 57}}},
         {52.45, 46.89, 444151, "Cataract River Cruise",
                                {NORMAL    = {80240, 2944, 60, 65},
                                 ADVANCED  = {80247, 2950, 58, 61},
                                 REVERSE   = {80253, 2956, 57, 60}}},
         {66.61, 68.72, 444152, "Taelloch Twist",
                                {NORMAL    = {80242, 2945, 47, 52},
                                 ADVANCED  = {80248, 2951, 43, 46},
                                 REVERSE   = {80254, 2957, 44, 47}}},
         {63.53, 75.15, 444154, "Opportunity Point Amble",
