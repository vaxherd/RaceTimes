...
local ZONES = {
    ...
    Zone("Undermine", 2346, {
         {39.223,11.360,466685, "Scrapshop Shot",
                                {NORMAL    = {85099, 3124, 36, 46},
                                 REVERSE   = {85100, 3125, 36, 46}}},
         {39.044,28.683,466683, "Skyrocketing Sprint",
                                {NORMAL    = {85071, 3119, 32, 42},
                                 REVERSE   = {85096, 3121, 32, 42}}},
         {25.489,42.122,466686, "Rags to Riches Rush",
    ...
    Zone("Eastern Kingdoms", 13, {
        {53.657,31.277,416849, "Plagueland Plunge",
                                {NORMAL    = {76510, 2545, 63, 68},
                                 ADVANCED  = {76512, 2561, 53, 56},
                                 REVERSE   = {76513, 2577, 58, 61}}},
        {40.688,44.027,416839, "Gilneas Gambit",
                                {NORMAL    = {76309, 2536, 78, 83},
                                 ADVANCED  = {76310, 2552, 74, 77},
                                 REVERSE   = {76311, 2568, 74, 77}}},
        {48.268,59.770,416847, "Ironforge Interceptor",
                                {NORMAL    = {76445, 2543, 70, 75},
                                 ADVANCED  = {76446, 2559, 64, 67},
                                 REVERSE   = {76447, 2575, 60, 63}}},
        {52.674,58.636,416840, "Loch Modan Loop",
                                {NORMAL    = {76339, 2537, 63, 68},
                                 ADVANCED  = {76340, 2553, 61, 64},
                                 REVERSE   = {76341, 2569, 63, 66}}},
        {55.087,59.187,416842, "Twilight Terror",
                                {NORMAL    = {76364, 2539, 73, 78},
                                 ADVANCED  = {76365, 2555, 68, 71},
                                 REVERSE   = {76366, 2571, 66, 69}}},
        {60.016,52.712,416852, "Krazzworks Klash",
                                {NORMAL    = {76527, 2548, 71, 76},
                                 ADVANCED  = {76528, 2564, 64, 67},
                                 REVERSE   = {76529, 2580, 62, 65}}},
        {54.330,65.497,416851, "Fuselight Night Flight",
                                {NORMAL    = {76523, 2547, 64, 69},
                                 ADVANCED  = {76524, 2563, 58, 61},
                                 REVERSE   = {76525, 2579, 58, 61}}},
        {49.406,65.956,416841, "Searing Slalom",
                                {NORMAL    = {76357, 2538, 52, 57},
                                 ADVANCED  = {76358, 2554, 46, 49},
                                 REVERSE   = {76359, 2570, 43, 46}}},
        {46.336,74.554,416844, "Elwynn Forest Flash",
                                {NORMAL    = {76397, 2541, 73, 78},
                                 ADVANCED  = {76399, 2557, 66, 69},
                                 REVERSE   = {76400, 2573, 63, 66}}},
        {50.808,74.103,416853, "Redridge Rally",
                                {NORMAL    = {76536, 2549, 57, 62},
                                 ADVANCED  = {76537, 2565, 52, 55},
                                 REVERSE   = {76538, 2581, 52, 55}}},
        {53.166,82.499,416848, "Blasted Lands Bolt",
                                {NORMAL    = {76469, 2544, 69, 74},
                                 ADVANCED  = {76470, 2560, 62, 65},
                                 REVERSE   = {76471, 2576, 64, 67}}},
        {49.485,81.940,416843, "Deadwind Derby",
                                {NORMAL    = {76380, 2540, 60, 65},
                                 ADVANCED  = {76381, 2556, 59, 62},
                                 REVERSE   = {76382, 2572, 59, 62}}},
        {47.378,84.416,416846, "Gurubashi Gala",
                                {NORMAL    = {76438, 2542, 56, 61},
                                 ADVANCED  = {76439, 2558, 49, 52},
                                 REVERSE   = {76440, 2574, 50, 53}}},
        {43.343,94.810,416850, "Booty Bay Blast",
                                {NORMAL    = {76515, 2546, 63, 68},
                                 ADVANCED  = {76516, 2562, 57, 60},
                                 REVERSE   = {76517, 2578, 56, 59}}},
    }),
    ...
    Zone("Kalimdor", 12, {
         ...
         {65.612,32.161,415870, "Rocketway Ride",  -- Listed in the Kalimdor Cup quest objectives as "The Azshara Rocketway Ride", but the best times aura name is just "Rocketway Ride".
